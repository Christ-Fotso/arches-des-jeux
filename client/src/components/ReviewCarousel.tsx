    ...
    <div className={cn("w-full py-10", className)}>
      <div className="text-center mb-8">
        ...
        <div className="flex items-center justify-center gap-2 mb-4">
          ...
          <a 
            href="https://www.google.com/maps/place/L'arche+des+jeux/@30.886403,-49.4022061,3z/data=!4m8!3m7!1s0x4a043829dff160e9:0x6a4e8395c82f028!8m2!3d30.886403!4d-49.4022062!9m1!1b1!16s%2Fg%2F11x80y79gk!18m1!1e1?entry=ttu" 
            target="_blank" 
            rel="noopener noreferrer"
            className="text-muted-foreground ml-1 hover:text-primary hover:underline transition-colors"
          >
                  ...
                  <Card className="h-full border-2 border-primary/5 hover:border-primary/20 transition-colors shadow-sm">
                    <CardContent className="flex flex-col h-full p-6">
                      ...
                      <div className="flex justify-between items-start mb-4">
                        ...
                        {/* Petit logo "G" cliquable vers Google Maps */}
                        <a 
                          href="https://www.google.com/maps/place/L'arche+des+jeux/@30.886403,-49.4022061,3z/data=!4m8!3m7!1s0x4a043829dff160e9:0x6a4e8395c82f028!8m2!3d30.886403!4d-49.4022062!9m1!1b1!16s%2Fg%2F11x80y79gk!18m1!1e1?entry=ttu"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center hover:bg-gray-200 transition-colors"
                          title="Voir l'avis sur Google Maps"
                        >
